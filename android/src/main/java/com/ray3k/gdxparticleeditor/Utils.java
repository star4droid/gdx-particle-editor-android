...
/**
 * A convenience class with various static methods that perform various utility tasks throughout GDX
 * Particle Editor.
 */
public class Utils {
  ...
  public static void checkVersion(VersionUpdateRunnable updater) {
    if (!preferences.getBoolean(
        Settings.NAME_CHECK_FOR_UPDATES, Settings.DEFAULT_CHECK_FOR_UPDATES)) return;
